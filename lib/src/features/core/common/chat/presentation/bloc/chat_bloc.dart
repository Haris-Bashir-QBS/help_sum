...
class ChatBloc extends Bloc<ChatEvent, ChatState> {
  ...
  Future<void> _onLoadInboxChats(LoadInboxChats event, Emitter<ChatState> emit) async {
  ...
  Future<void> _loadChatHistoryWithRetry(String to, Emitter<ChatState> emit) async {
    int attempts = 0;
  ...
  void _onChatHistoryReceived(ChatHistoryReceived event, Emitter<ChatState> emit) {
    emit(state.copyWith(
